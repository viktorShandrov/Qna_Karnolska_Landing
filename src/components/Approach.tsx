  ...
  return (
    <section id="approach" className="py-24 md:py-32 bg-[#FBF9F5]">
      <div className="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* 3 Columns */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 max-w-5xl mx-auto items-start">
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <p className="font-serif italic text-xs sm:text-[13.5px] text-[#4A4846] leading-relaxed font-light max-w-xs">
