      ...
      <div className="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 max-w-6xl mx-auto items-start">
          ...
          <div className="flex flex-col items-center text-center group">
            <div className="mb-0 text-[#3E3C3A] transition-transform duration-300 group-hover:scale-105">
              <svg viewBox="0 0 48 48" fill="none" className="w-[100px] h-[100px] stroke-current">
                <path
            ...
            <p className="font-serif italic text-lg lg:text-[22.5px] text-[#4A4846] leading-relaxed font-light max-w-xs sm:max-w-sm">
